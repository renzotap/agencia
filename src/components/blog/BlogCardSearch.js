                ...
                <div className="lg:flex min-w-0 lg:flex-1 items-center">
                  ...
                  <div className="min-w-0 flex-1 px-8 p-4 ">
                    ...
                    <div className="">
                        ...
                        <span className=" hover:text-indigo-500  mx-1 font-medium text-gray-800 text-sm "><Link to={`/category/${data.category.slug}`}>{data.category.name}</Link></span> <span className="text-gray-300">&middot;</span> 
