...
function Header(){
    ...
    return(
        ...
        <div className="relative px-6 ">
          <div className="mx-auto max-w-1700 xl:mx-12 xl:pt-40 xl-pb-64 lg:pt-36 sm:pt-48 sm:pb-40">
            <div>
              <div>
                <div className='pb-40 '>
                  <h1 className="text-4xl font-bold tracking-tight pb-16 pt-20  sm:text-6xl">
