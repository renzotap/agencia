...
function Contact(){
    ...
    return(
        <div className="w-full h-auto shadow-card rounded-lg p-12">
            <h1 className="font-bold text-4xl text-gray-900">Wants to work with us?</h1>
            <p className="font-regular mt-4 text-2xl text-gray-700"> Just tell us about your project</p>
                    ...
                    <div className="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                        <div className="grid-cols-12 ml-4 mt-2 flex">
                            <Switch
                                checked={enabled}
                                onChange={setEnabled}
                                className={`${enabled ? 'bg-indigo-500' : 'bg-gray-300'}
                            ...
                            <p className="col-span-6 ml-4 text-md font-regular leading-6 text-gray-600 ">
                        ...
                        <div className="  mt-2 flex-shrink-0">
                            {
                                loading ?
                                <div
                                    className="relative inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-3 text-lg font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                >
