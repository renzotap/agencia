...
function PositionsList(){
    return(
        <div className="max-w-full mx-12 bg-white">
            <h2 className="text-5xl font-bold text-gray-900 pb-8">Open Positions </h2>
            <p className="text-2xl font-regular text-gray-900 max-w-5xl leading-10">Let's write some beautiful code and make smarts designs. </p>
