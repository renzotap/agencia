...
import Contact from "components/services/javascriptdev/Contact";
                ...
                <div className="pt-28">
                    <div className="mx-auto max-w-1700 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mx-auto max-w-1700">
                            ...
                            <Features/>
                            <TechStack/>
                            <div className="pt-10 px-4 py-5 sm:px-8">
                            ...
                            <div className="grid grid-cols-12  ">
                                ...
                                <section className="bg-black mx-4 mt-32 rounded-lg   ">
                                    <div className="mx-auto max-w-auto  md:px-6 lg:px-8 ">
                                    <div className="py-12  md:flex md:flex-col  md:py-24 md:pl-0 ">
                                        <div className="md:flex-shrink-0">
                                        <img className="h-12" src="https://tailwindui.com/img/logos/tuple-logo-indigo-300.svg" alt="Tuple" />
                                        </div>
                                        <blockquote className="mt-6 md:flex md:flex-grow md:flex-col mx-8">
