...
function About(){
    ...
    return(
        <Layout>
            <Helmet>
                <title>BrainRemoteControl | Nosotros</title>
            ...
            <div className="pt-28">
                ...
                <Team/>
                <div className="bg-white">
                <div className="mx-12 lg:full max-w-full py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
